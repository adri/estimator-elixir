defmodule Estimator.Web.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Estimator.MyChannel do
        use Estimator.Web, :channel
        alias Estimator.Presence
  ...
  The function receives a topic and map of players and must return a
  ...
  have registered players for the given topic. The fetched
  information is then extended with a `:user` key of the user's
  information, while maintaining the required `:metas` field from the
  original presence data.
  """
  use Phoenix.Presence, otp_app: :estimator,
                        pubsub_server: Estimator.PubSub
end
